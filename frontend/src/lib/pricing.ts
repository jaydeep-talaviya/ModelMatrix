...
const RULES: Rule[] = [
  ...
  { re: /gpt-5\.6/i, provider: 'openai', price: { input: 2.0, output: 10.0 } },
  { re: /gpt-5\.5-pro/i, provider: 'openai', price: { input: 30.0, output: 180.0 } },
  { re: /gpt-5\.5/i, provider: 'openai', price: { input: 5.0, output: 30.0 } },
  { re: /gpt-5\.4.*mini/i, provider: 'openai', price: { input: 0.75, output: 4.5 } },
  { re: /gpt-5\.4.*nano/i, provider: 'openai', price: { input: 0.2, output: 1.25 } },
  { re: /gpt-5\.4-image/i, provider: 'openai', price: { input: 8.0, output: 15.0 } },
  { re: /gpt-5\.4-pro/i, provider: 'openai', price: { input: 30.0, output: 180.0 } },
  ...
  { re: /o1-pro/i, provider: 'openai', price: { input: 150.0, output: 600.0 } },
